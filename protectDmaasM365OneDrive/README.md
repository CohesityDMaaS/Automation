...
```powershell
./protectDmaasM365OneDrive.ps1 -region us-east-2 -policyName Gold -sourceName mydomain.onmicrosoft.com -users user1.mydomain.onmicrosoft.com, user2.mydomain.onmicrosoft.com -userList ./userlist.txt
```
