...
```powershell
# Download Commands
$scriptName = 'Protect_CCS_M365Teams'
...
* Protect_CCS_M365Teams.ps1: the main powershell script
* cohesity-api.ps1: the Cohesity REST API helper module

Place both files in a folder together and run the main script like so:

```powershell
./Protect_CCS_M365Teams.ps1 -region us-east-2 -policyName Gold -sourceName mydomain.onmicrosoft.com -teams user1.mydomain.onmicrosoft.com, user2.mydomain.onmicrosoft.com -teamsList ./teamslist.txt
```
...
* -teams: (optional) one or more MS Teams names (comma separated)
* -teamsList: (optional) text file of Teams names (one per line)
