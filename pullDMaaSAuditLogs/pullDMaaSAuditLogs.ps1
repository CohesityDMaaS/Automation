...
if($actions) {
    ...
    write-host "Audit Pull FAILED! The appropriate DMaaS Parameters could not be called.`n" -ForegroundColor Red
    write-output "$dateTime    FAIL    Audit Pull FAILED! The appropriate DMaaS Parameters could not be called.`n" | Out-File -FilePath $outfileName -Append
}
