...
param (
    ...
    [Parameter(Mandatory = $True)][string]$regionId,  # DMaaS Generic NAS Source Region Id
    [Parameter()][array]$groupsNames,  # optional names of sites protect
    [Parameter()][string]$groupsList = '',  # optional textfile of sites to protect
...
$objectsToAdd = @(gatherList -Param $groupsames -FilePath $ogroupsList -Name 'groups' -Required $False)
