...
This script will extend the retention of the last-day-of-month snapshots to the end of X months. Processed snapshots will be logged to extendLog_$timestamp.txt.
