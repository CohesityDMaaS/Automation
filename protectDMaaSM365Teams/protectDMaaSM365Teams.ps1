...
param (
    ...
    [Parameter()][array]$teams,  # optional names of teams to protect
    [Parameter()][string]$teamsList,  # optional textfile of teams to protect
...
# gather list of teams to protect
$teamsToAdd = @()
