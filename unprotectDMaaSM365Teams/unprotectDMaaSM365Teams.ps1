...
param (
    ...
    [Parameter()][array]$teams,  # optional names of teams to unprotect
    [Parameter()][string]$teamsList = '',  # optional textfile of teams to unprotect
...
# gather list of teams to unprotect
$teamsToAdd = @()
