...
param (
    ...
    [Parameter()][array]$groups,  # optional names of groups to unprotect
    [Parameter()][string]$groupsList = '',  # optional textfile of groups to unprotect
...
# gather list of groups to unprotect
$groupsToAdd = @()
