...
```powershell
# Download Commands
$scriptName = 'Protect_CCS_M365OneDrive'
...
* Protect_CCS_M365OneDrive.ps1: the main powershell script
* cohesity-api.ps1: the Cohesity REST API helper module

Place both files in a folder together and run the main script like so:

```powershell
./Protect_CCS_M365OneDrive.ps1 -region us-east-2 -policyName Gold -sourceName mydomain.onmicrosoft.com -users user1.mydomain.onmicrosoft.com, user2.mydomain.onmicrosoft.com -userList ./userlist.txt
```
