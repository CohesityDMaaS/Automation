...
```powershell
./protectDmaasM365Mailboxes.ps1 -region us-east-2 -policyName Gold -sourceName mydomain.onmicrosoft.com -mailboxes user1.mydomain.onmicrosoft.com, user2.mydomain.onmicrosoft.com -mailboxList ./mailboxlist.txt
```
