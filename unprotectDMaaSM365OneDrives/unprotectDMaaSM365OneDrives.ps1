...
param (
    ...
    [Parameter()][array]$users,  # optional names of onedrives to protect
    [Parameter()][string]$userList = '',  # optional textfile of onedrives to protect
...
# gather list of onedrives to protect
$usersToAdd = @()
