...
param (
    ...
    [Parameter(Mandatory = $True)][string]$saasConn,  # name of SaaS Connection to associate with Physical Server Source
...
$outfileName = "log-Register_CCS_physicalSources-$dateString.txt"
