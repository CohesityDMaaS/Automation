...
```powershell
# Download Commands
$scriptName = 'Protect_CCS_M365Groups'
...
* Protect_CCS_M365Groups.ps1: the main powershell script
* cohesity-api.ps1: the Cohesity REST API helper module

Place both files in a folder together and run the main script like so:

```powershell
./Protect_CCS_M365Groups.ps1 -region us-east-2 -policyName Gold -sourceName mydomain.onmicrosoft.com -groupsNames user1.mydomain.onmicrosoft.com, user2.mydomain.onmicrosoft.com -groupsList ./groupslist.txt
```
...
* -groupsNames: (optional) one or more Group names (comma separated)
...
* -autoselect: (optional) default is 0
